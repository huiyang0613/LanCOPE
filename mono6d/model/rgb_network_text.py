...
from model.trans_hypothesis_text import FSAM, FCAM
...
class text_FSAM(nn.Module):
    def __init__(self):
        super(text_FSAM, self).__init__()
        self.text_FSAM = FSAM(512, 16, True, None, 0.0, 0.0)
    def forward(self, text_global):
        pose_emb = self.text_FSAM(text_global)
        return pose_emb
    

class pts_to_rgb_to_text_FCAM(nn.Module):
    def __init__(self):
        super(pts_to_rgb_to_text_FCAM, self).__init__()
        self.pts_to_rgb_to_text_FCAM = FCAM(512, 16, True, None, 0.0, 0.0)
    def forward(self, pts_global, rgb_global, text_global):
        pose_emb = self.pts_to_rgb_to_text_FCAM(pts_global, rgb_global, text_global)
        return pose_emb

class rgb_to_pts_to_text_FCAM(nn.Module):
    def __init__(self):
        super(rgb_to_pts_to_text_FCAM, self).__init__()
        self.rgb_to_pts_to_text_FCAM = FCAM(512, 16, True, None, 0.0, 0.0)
    def forward(self, rgb_global, pts_global, text_global):
        pose_emb = self.rgb_to_pts_to_text_FCAM(rgb_global, pts_global, text_global)
        return pose_emb


class text_to_pts_to_rgb_FCAM(nn.Module):
    def __init__(self):
        super(text_to_pts_to_rgb_FCAM, self).__init__()
        self.text_to_pts_to_rgb_FCAM = FCAM(512, 16, True, None, 0.0, 0.0)
    def forward(self, text_global, pts_global, rgb_global):
        pose_emb = self.text_to_pts_to_rgb_FCAM(text_global, pts_global, rgb_global)
        return pose_emb
...
class pose_s_condition_FCAM1(nn.Module):
    def __init__(self):
        ...
        self.denoise_net_FCAM12 = FSAM(1408+512, 16, True, None, 0.0, 0.0)
...
class pose_s_condition_concat2(nn.Module):
    def __init__(self):
        ...
        self.concat = nn.Linear(1408*2+1024, 1408+512)
