...
import torch
import gorilla
# from model.diffusion import cosine_beta_schedule
...
def get_parser():
    ...
    parser.add_argument("--config",
                        type=str,
                        default="config/rgb_diffusion_pose.yaml",
...
if __name__ == "__main__":
    ...
    if cfg.model_arch == "diffusion":
        from model.rgb_diffusion_pose_text_twosa import DIFFUSION, SupervisedLoss
        model = DIFFUSION()
    else:
    ...
    # data_mode = cfg.get("data_mode", "Real") 
