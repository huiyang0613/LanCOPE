...
from provider.dataset import TestDataset, TestCAMERADataset
...
def get_parser():
    ...
    parser.add_argument("--config",
                        type=str,
                        default="config/rgb_diffusion_pose_three_text_cameraissynthetic_long_dense.yaml",
...
if __name__ == "__main__":
    ...
    if not cfg.only_eval:
        ...
        if cfg.model_arch == "diffusion":
            from model.rgb_diffusion_pose_three_text_dense_2 import DIFFUSION
            model = DIFFUSION()
        ...
        # TestingCAMERADataset = TestCAMERADataset
        # dataset = TestingCAMERADataset(cfg.test, BASE_DIR)
